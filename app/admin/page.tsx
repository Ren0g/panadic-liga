...
export default function AdminPage() {
  ...
  const saveResult = async () => {
    ...
    // ponovni refresh svih podataka
    loadFixtures();

    // refresh LeagueView tablice i nadolazeće utakmice
    setRefreshKey((k) => k + 1);
  };
  ...
  return (
    <div className="p-4 space-y-8">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-4 py-2 rounded ${
            leagueCode === "PIONIRI" ? "bg-green-600 text-white" : "bg-gray-200"
          }`}
        >
          Pioniri
        </button>
        ...
        <button
          ...
          className={`px-4 py-2 rounded ${
            leagueCode === "MLADJI" ? "bg-green-600 text-white" : "bg-gray-200"
          }`}
        >
          Mlađi pioniri
        </button>
      ...
      {/* SVE UTAKMICE */}
      <div>
        <h2 className="text-xl font-semibold mb-2">Sve utakmice</h2>
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-left">Domaćin (ID)</th>
                <th className="text-left">Gost (ID)</th>
